...
// FIX-2026-09-17: read faiz DB AppConfig orphanRecoveryLastStats / orphanRecoveryLastRunAt
// MUST set MONGODB_URI BEFORE any require that touches config (footgun)
